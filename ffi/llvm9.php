...
';
    ...
    public function LLVMGetDebugLocDirectory(?LLVMValueRef $p0, ?int_ptr $p1): ?int_ptr {
        $result = $this->ffi->LLVMGetDebugLocDirectory($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData());
        return $result === null ? null : new int_ptr($result);
    }
    public function LLVMGetDebugLocFilename(?LLVMValueRef $p0, ?int_ptr $p1): ?int_ptr {
    ...
    public function LLVMConstGEP2(?LLVMTypeRef $p0, ?LLVMValueRef $p1, ?LLVMValueRef_ptr $p2, ?int $p3): ?LLVMValueRef {
        $result = $this->ffi->LLVMConstGEP2($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData(), $p2 === null ? null : $p2->getData(), $p3);
        return $result === null ? null : new LLVMValueRef($result);
    }
    ...
    public function LLVMConstInBoundsGEP2(?LLVMTypeRef $p0, ?LLVMValueRef $p1, ?LLVMValueRef_ptr $p2, ?int $p3): ?LLVMValueRef {
        $result = $this->ffi->LLVMConstInBoundsGEP2($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData(), $p2 === null ? null : $p2->getData(), $p3);
        return $result === null ? null : new LLVMValueRef($result);
    }
