...
interface illvm {}
class llvm {
    const SOFILE = '/usr/lib/llvm-7/lib/libLLVM-7.so.1';
...
';
    ...
    public function LLVMAddAggressiveInstCombinerPass(?LLVMPassManagerRef $p0): void {
        $this->ffi->LLVMAddAggressiveInstCombinerPass($p0 === null ? null : $p0->getData());
    }
