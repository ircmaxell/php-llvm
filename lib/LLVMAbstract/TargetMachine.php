...
class TargetMachine implements CoreTargetMachine {
    ...
    public function getTarget(): CoreTarget {
        return $this->llvm->factory->target($this->llvm->lib->LLVMGetTargetMachineTarget($this->machine));
    }
    ...
    public function createTargetDataLayout(): CoreTargetData {
        return $this->llvm->factory->targetData($this->llvm->lib->LLVMCreateTargetDataLayout($this->machine));
    }
